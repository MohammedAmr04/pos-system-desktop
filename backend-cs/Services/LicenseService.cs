...
{
    /// <summary>
    /// Server-side license unlock code. The code is derived from the machine id with a
    /// secret that lives only on the backend — it is NOT shipped in the frontend bundle
    /// (fixes audit risk #2/#7). Operators receive the 4-digit code from the vendor.
    /// </summary>
