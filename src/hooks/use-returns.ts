...
export function useSaleReturnsPage(page: number, pageSize: number, invoiceId?: string) {
  return useQuery({
...
export function usePurchaseReturnsPage(page: number, pageSize: number, purchaseId?: string) {
  return useQuery({
